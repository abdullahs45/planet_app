...
class Uranus_Item extends StatefulWidget {
  const Uranus_Item({super.key});

  @override
  State<Uranus_Item> createState() => _Uranus_ItemState();
}

class _Uranus_ItemState extends State<Uranus_Item> {
  @override
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          width: width * 0.56,
                          child: Text(
                            'An ice giant with a tilted axis, causing extreme seasonal changes.',
                            style: TextStyle(
