...
class Neptune_Item extends StatefulWidget {
  const Neptune_Item({super.key});

  @override
  State<Neptune_Item> createState() => _Neptune_ItemState();
}

class _Neptune_ItemState extends State<Neptune_Item> {
  @override
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          width: width * 0.56,
                          child: Text(
                            'The farthest known planet, an ice giant with supersonic winds and a deep blue color.',
                            style: TextStyle(
