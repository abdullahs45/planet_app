...
class Pluto_Item extends StatefulWidget {
  const Pluto_Item({super.key});

  @override
  State<Pluto_Item> createState() => _Pluto_ItemState();
}

class _Pluto_ItemState extends State<Pluto_Item> {
  @override
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          width: width * 0.56,
                          child: Text(
                            'Once considered the ninth planet, now classified as a dwarf planet, known for its icy surface and elliptical orbit.',
                            style: TextStyle(
