...
class Saturn_Item extends StatefulWidget {
  const Saturn_Item({super.key});

  @override
  State<Saturn_Item> createState() => _Saturn_ItemState();
}

class _Saturn_ItemState extends State<Saturn_Item> {
  @override
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          width: width * 0.56,
                          child: Text(
                            'Famous for its stunning ring system, it is another gas giant with numerous moons.',
                            style: TextStyle(
